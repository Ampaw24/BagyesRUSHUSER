...
import 'package:bagyesrushappusernew/src/report/viewmodel/report_detail_viewmodel.dart';
import 'package:bagyesrushappusernew/src/report/widgets/report_status_badge.dart';
...
class _ReportDetailViewState extends State<ReportDetailView> {
  late final ReportDetailViewModel _vm;

  @override
  void initState() {
    super.initState();
    _vm = sl<ReportDetailViewModel>(
      param1: widget.reportId,
      param2: widget.role,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: switch (state) {
        ...
        ReportDetailError(:final message) => Center(
          child: Padding(
        ...
        ReportDetailLoaded(:final report) => ListView(
