...
import '../../viewmodel/payout_providers_viewmodel.dart';
import '../widgets/payout_provider_dropdown.dart';
import '../widgets/payout_provider_visuals.dart';
...
/// Screen for adding a new saved payout/payment method. Shared between the
/// consumer and vendor Payment Methods flows — both push this on top of
/// their own [PaymentViewModel] (already configured for `isVendor`), and
/// pop with the created [PaymentMethod] (or nothing, on cancel/failure).
...
class _AddPaymentMethodScreenState extends State<AddPaymentMethodScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final accent = _provider != null ? payoutProviderVisual(_provider!).color : AppColors.primary;
          ...
          child: ListView(
            ...
            children: [
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Padding(
                          ...
                          child: HugeIcon(
                            ...
                            color: _provider != null ? accent : AppColors.textSecondary,
                            size: w * 0.05,
                          ),
                        ),
              ...
              Text(
                ...
                style: TextStyle(fontSize: w * 0.031, color: AppColors.textHint),
              ),
