...
import 'package:bagyesrushappusernew/src/restaurant/widgets/restaurant_card.dart';
...
class ConsumerSearchView extends StatefulWidget {
  const ConsumerSearchView({super.key});

  @override
  State<ConsumerSearchView> createState() => _ConsumerSearchViewState();
}

class _ConsumerSearchViewState extends State<ConsumerSearchView> {
  ...
  Widget build(BuildContext context) {
    ...
    final searchState = context.watch<SearchViewModel>().state;
